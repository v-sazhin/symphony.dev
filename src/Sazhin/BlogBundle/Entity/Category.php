 ...
 * @ORM\Entity(repositoryClass="Sazhin\BlogBundle\Repository\CategoryRepository")
 */
class Category
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Sazhin\BlogBundle\Entity\Post", mappedBy="categories")
     */
    private $posts;
